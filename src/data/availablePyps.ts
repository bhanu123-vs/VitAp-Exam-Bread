...
const RAW_INITIAL_AVAILABLE_PYPS: AvailablePyqPaper[] = [
  ...
  {
    id: 'pyp-cse2008-cat2-2025',
    courseName: 'Operating Systems',
    courseCode: 'CSE2008',
    examType: 'cat2',
    year: 2025,
    semester: 'Continuous Assessment Test (CAT-2)',
    totalQuestions: 15,
    totalMarks: 50,
    timeDuration: '1.5 Hours',
    fileSize: '1.7 MB',
    fileName: 'VIT_AP_CSE2008_CAT2_2025.pdf',
    university: 'VIT-AP University, Amaravati (SCOPE)',
    topicsCovered: ['Deadlocks', 'Bankers Safety Algorithm', 'Paging & TLB', 'FIFO & LRU Page Replacement', 'Thrashing'],
    isAvailableForDownload: true,
    sampleQuestions: [
      { number: '1', section: 'Part A', text: 'State the four Coffman deadlock conditions. Explain how Hold and Wait condition can be systematically prevented.', marks: 6 },
      { number: '2', section: 'Part A', text: 'Explain Translation Lookaside Buffer (TLB). Calculate Effective Memory Access Time (EMAT) with 80% TLB hit ratio and 100ns memory cycle time.', marks: 8 },
      { number: '3', section: 'Part B', text: 'Consider system with 5 processes (P0-P4) and 3 resources (A:10, B:5, C:7). Allocation and Max matrices given. Calculate Need matrix and determine if system is safe using Banker\'s Algorithm.', marks: 14 },
      { number: '4', section: 'Part B', text: 'Trace page faults for string: 7, 0, 1, 2, 0, 3, 0, 4, 2, 3, 0, 3, 2 for FIFO, LRU, and Optimal replacement using 3 frames. Demonstrate Belady\'s Anomaly.', marks: 12 },
      { number: '5', section: 'Part B', text: 'Explain Thrashing and discuss Working-Set Model and Page Fault Frequency schemes for detection and recovery.', marks: 10 },
    ],
  },
  {
  ...
  // ====================================================
  // CSE1012: PROBLEM SOLVING USING PYTHON (SCOPE)
  // ====================================================
  {
    id: 'pyp-cse1012-cat1-2025',
    courseName: 'Problem Solving using Python',
    courseCode: 'CSE1012',
    examType: 'cat1',
    year: 2025,
    semester: 'Continuous Assessment Test 1 (CAT-1)',
    totalQuestions: 12,
    totalMarks: 50,
    timeDuration: '1.5 Hours',
    fileSize: '1.6 MB',
    fileName: 'VIT_AP_CSE1012_CAT1_2025.pdf',
    university: 'VIT-AP University, Amaravati (SCOPE)',
    topicsCovered: ['Flowcharts & Pseudocode', 'Control Branching (if-elif-else)', 'Iterative Loops (for/while)', 'Functions & Scoping', 'Recursion & Base Cases'],
    isAvailableForDownload: true,
    sampleQuestions: [
      { number: '1.(a)', section: 'Part A (Compulsory)', text: 'Explain the precedence of operators in Python with an example evaluating arithmetic, relational, and logical operators.', marks: 6 },
      { number: '1.(b)', section: 'Part A (Compulsory)', text: 'Write a Python script using a while loop to check whether a given 3-digit positive integer is an Armstrong number.', marks: 8 },
      { number: '2.(a)', section: 'Part B (Answer any 3)', text: 'Write a recursive Python function to compute the Greatest Common Divisor (GCD) of two numbers using Euclid\'s algorithm. Contrast with an iterative approach.', marks: 12 },
      { number: '2.(b)', section: 'Part B (Answer any 3)', text: 'Explain default arguments, keyword arguments, and variable-length arguments (*args and **kwargs) in Python functions with working syntax.', marks: 12 },
      { number: '3.(a)', section: 'Part B (Answer any 3)', text: 'Demonstrate lambda functions combined with filter() and map() to extract all prime numbers from a given list of integers.', marks: 12 },
    ],
  },
  {
    id: 'pyp-cse1012-cat2-2025',
    courseName: 'Problem Solving using Python',
    courseCode: 'CSE1012',
    examType: 'cat2',
    year: 2025,
    semester: 'Continuous Assessment Test 2 (CAT-2)',
    totalQuestions: 14,
    totalMarks: 50,
    timeDuration: '1.5 Hours',
    fileSize: '1.8 MB',
    fileName: 'VIT_AP_CSE1012_CAT2_2025.pdf',
    university: 'VIT-AP University, Amaravati (SCOPE)',
    topicsCovered: ['Lists & Slicing', 'Dictionaries & Sets', 'File I/O (Context Managers)', 'CSV File Parsing', 'try-except-finally & Custom Exceptions'],
    isAvailableForDownload: true,
    sampleQuestions: [
      { number: '1.(a)', section: 'Part A (Compulsory)', text: 'Differentiate between shallow copy and deep copy in Python lists and nested dictionaries with memory reference illustrations.', marks: 6 },
      { number: '1.(b)', section: 'Part A (Compulsory)', text: 'Explain set operations (union, intersection, difference, symmetric difference) and list comprehensions with conditional filtering.', marks: 8 },
      { number: '2.(a)', section: 'Part B (Answer any 3)', text: 'Write a Python program to read a CSV file containing student records (RegNo, Name, CAT1, CAT2, FAT), compute total marks, and write rankers with >80% into "rankers.csv".', marks: 14 },
      { number: '2.(b)', section: 'Part B (Answer any 3)', text: 'Explain try-except-else-finally construct in Python. Create a custom exception InvalidAgeError and demonstrate raising and handling it in user input.', marks: 12 },
      { number: '3.(a)', section: 'Part B (Answer any 3)', text: 'Given a text file "article.txt", write a Python script to count the frequency of each word and output the top 5 most frequent words sorted alphabetically.', marks: 10 },
    ],
  },
  {
    id: 'pyp-cse1012-fat-2025',
    courseName: 'Problem Solving using Python',
    courseCode: 'CSE1012',
    examType: 'end_term',
    year: 2025,
    ...
    timeDuration: '3 Hours',
    fileSize: '2.5 MB',
    fileName: 'VIT_AP_CSE1012_FAT_2025.pdf',
    university: 'VIT-AP University, Amaravati (SCOPE)',
    topicsCovered: ['Control Constructs', 'Recursion', 'Dictionary Aggregation', 'File I/O & CSV', 'Regex (re module)', 'OOP Classes & Inheritance'],
    isAvailableForDownload: true,
    sampleQuestions: [
      { number: '1.(a)', section: 'Part A', text: 'Demonstrate list comprehensions, dictionary comprehensions, and generator expressions with memory and performance comparisons.', marks: 10 },
      { number: '1.(b)', section: 'Part A', text: 'Write Python code using regular expressions (re module) to validate an email address and extract date strings in DD-MM-YYYY format.', marks: 10 },
      { number: '2.(a)', section: 'Part B', text: 'Implement an Object-Oriented "BankSystem" class in Python with private attributes, deposit(), withdraw(), and transfer() methods. Handle InsufficientFundsException.', marks: 14 },
      { number: '2.(b)', section: 'Part B', text: 'Write a program to perform file operations using context managers ("with" statement) to merge contents of three text files into a single master file with line numbers.', marks: 14 },
      { number: '3.(a)', section: 'Part B', text: 'Illustrate inheritance and polymorphism in Python using an abstract base class Shape with derived subclasses Circle and Rectangle calculating area and perimeter.', marks: 12 },
    ],
  },
  {
    id: 'pyp-cse1012-fat-2024',
    courseName: 'Problem Solving using Python',
    courseCode: 'CSE1012',
    examType: 'end_term',
    year: 2024,
    semester: 'Winter Semester (University Core)',
    totalQuestions: 27,
    totalMarks: 100,
    timeDuration: '3 Hours',
    fileSize: '2.2 MB',
    fileName: 'VIT_AP_CSE1012_FAT_2024.pdf',
    university: 'VIT-AP University, Amaravati (SCOPE)',
    topicsCovered: ['Nested Dictionaries', 'File Processing', 'Lambda & Map', 'OOP Encapsulation', 'Exception Hierarchy'],
    isAvailableForDownload: true,
    sampleQuestions: [
      { number: '1.(a)', section: 'Part A', text: 'Given a nested dictionary of employee departments and salaries, write Python code to calculate department-wise average salary.', marks: 10 },
      { number: '2.(a)', section: 'Part B', text: 'Explain method overriding, super() constructor calls, and multiple inheritance MRO (Method Resolution Order) in Python.', marks: 12 },
    ],
  },

  // ====================================================
  // MAT1001: CALCULUS FOR ENGINEERS (SAS) - CAT1 & CAT2
  // ====================================================
  {
    id: 'pyp-mat1001-cat1-2025',
    courseName: 'Calculus for Engineers',
    courseCode: 'MAT1001',
    examType: 'cat1',
    year: 2025,
    ...
    timeDuration: '1.5 Hours',
    fileSize: '1.5 MB',
    fileName: 'VIT_AP_MAT1001_CAT1_2025.pdf',
    university: 'VIT-AP University, Amaravati (SAS)',
    topicsCovered: ['Curvature & Evolutes', 'Taylor Series of 2 Variables', 'Euler Theorem on Homogeneous Functions', 'Lagrange Multipliers Method'],
    isAvailableForDownload: true,
    sampleQuestions: [
      { number: '1', section: 'Part A', text: 'Find the radius of curvature for the parabola y^2 = 4ax at the vertex (0, 0) and at the point (a, 2a).', marks: 8 },
      { number: '2', section: 'Part A', text: 'State Euler\'s Theorem for homogeneous functions of two variables and verify it for u = x^3 + y^3 + 3x^2y.', marks: 8 },
      { number: '3', section: 'Part B', text: 'Expand e^x * cos(y) in powers of x and (y - pi/2) up to third-degree terms using Taylor\'s Series for two variables.', marks: 16 },
      { number: '4', section: 'Part B', text: 'Find the maximum and minimum values of f(x, y, z) = x + 2y + 3z subject to the constraint x^2 + y^2 + z^2 = 14 using Lagrange Multipliers.', marks: 18 },
    ],
  },
  {
    id: 'pyp-mat1001-cat2-2025',
    courseName: 'Calculus for Engineers',
    courseCode: 'MAT1001',
    examType: 'cat2',
    year: 2025,
    ...
    timeDuration: '1.5 Hours',
    fileSize: '1.6 MB',
    fileName: 'VIT_AP_MAT1001_CAT2_2025.pdf',
    university: 'VIT-AP University, Amaravati (SAS)',
    topicsCovered: ['Double Integrals', 'Change of Order of Integration', 'Triple Integrals in Spherical Coordinates', 'Beta & Gamma Function Properties'],
    isAvailableForDownload: true,
    sampleQuestions: [
      { number: '1', section: 'Part A', text: 'Evaluate the integral from 0 to 1, integral from 0 to x of (x + y) dy dx.', marks: 6 },
      { number: '2', section: 'Part A', text: 'Prove that Gamma(n + 1) = n * Gamma(n) and evaluate Gamma(1/2) = sqrt(pi).', marks: 8 },
      { number: '3', section: 'Part B', text: 'Evaluate by changing the order of integration: integral from 0 to 1, integral from x to 1 of sin(y^2) dy dx.', marks: 18 },
      { number: '4', section: 'Part B', text: 'Find the volume of the sphere x^2 + y^2 + z^2 = a^2 using triple integration in spherical polar coordinates.', marks: 18 },
    ],
  },
];
